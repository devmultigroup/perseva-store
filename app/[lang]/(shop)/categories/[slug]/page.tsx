...
type CategoryWithProducts = {
  ...
  products: Array<{ id: string; name: string; slug: string; short_description: string | null }>
}
...
export default async function CategoryPage({
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {category.description && <p className="mb-6 text-gray-600">{category.description}</p>}
